package com.pnwrain.flashsocket
{
	...
	public class FlashSocket extends EventDispatcher implements IWebSocketWrapper
	{
		...
		public function connect(domain:String, protocol:String = null, proxyHost:String = null, proxyPort:int = 0, headers:String = null):void
		{
			...
			*/
			...
			switch ( dm.type ){
				...
				case '4':
					...
					fe.data = com.adobe.serialization.json.JSON2.decode(dm.msg);
					dispatchEvent(fe);
					break;
				case '5':
					var m:Object = com.adobe.serialization.json.JSON2.decode(dm.msg);
				...
				case '6':
					...
					var args:Array = com.adobe.serialization.json.JSON2.decode(parts[2]);
		...
		public function send(msg:Object, event:String = null,callback:Function = null):void{
			...
			if ( event == null ){
				if ( msg is String){
					...
					webSocket.send('4:'+messageId+'::' + com.adobe.serialization.json.JSON2.encode(msg));
				}else{
					throw("Unsupported Message Type");
				}
			}else{
				webSocket.send('5:'+messageId+'::' + com.adobe.serialization.json.JSON2.encode({"name":event,"args":msg}));
			}
		}
